...
export default function Header() {
  ...
  const backgroundCol = navBackground ? "#FF5903" : "transparent";
  ...
  const navTextColor = navBackground ? "white" : "#FF5903";
  ...
  const navLogoColor = navBackground ? whiteLogo : orangeLogo;
